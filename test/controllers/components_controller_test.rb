...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference("Component.count") do
      post components_url, params: { component: { category: @component.category, code: @component.code, desc: @component.desc, lang: @component.lang, name: @component.name } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { category: @component.category, code: @component.code, desc: @component.desc, lang: @component.lang, name: @component.name } }
